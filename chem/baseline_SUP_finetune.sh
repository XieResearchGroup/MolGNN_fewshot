...
#do
nohup time
python finetune.py --input_model_file ${input_model_file}  --split ${split} --filename ${dataset}_SUP_BASE_${dropout_ratio}_splitseed_${seed}_${split}_finetune_${experiment_date} --dropout_ratio ${dropout_ratio}  --seed ${seed} \
...
> base_corrected/SUP_Base_finetune_seed${runseed}_${dropout_ratio}_splitseed_${seed}_${split}_${experiment_date}_${dataset}_output.log 2>&1 &
